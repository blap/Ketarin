...
namespace Ketarin.Async
{
    ...
    public class AsyncUpdater
    {
        ...
        /// </summary>
        protected virtual void OnProgressChanged(ApplicationJob job, short progress)
        {
            ProgressChanged?.Invoke(this, new JobProgressChangedEventArgs(progress, job));
        }
        ...
        /// <summary>
        /// Fires the UpdatesFound event.
        /// </summary>
        protected virtual void OnUpdatesFound(string[] updatedApps)
        {
            if (updatedApps.Length > 0)
            {
                UpdatesFound?.Invoke(this, new GenericEventArgs<string[]>(updatedApps));
            }
        }
