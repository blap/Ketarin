 ...
 * 2006-10-13  Implemented grouping and column sorting
 * 2006-10-09  Initial version
 *
 * TO DO:
...
namespace CDBurnerXP.Controls
{
    ...
    public partial class ObjectListView : ListView, ISupportInitialize
    {
        ...
        /// of a row. The delegate should return the value that the listview should actually
        /// use, which may be different to the one given to the delegate.
        /// </summary>
        public delegate CheckState CheckStatePutterDelegate(object rowObject, CheckState value);

        /// <summary>
        /// This delegate will be called whenever the ObjectListView needs to format a row.
        /// </summary>
        public delegate void RowFormatterDelegate(OLVListItem item);
            ...
            : base()
        {
            ...
            this.checkStateGetter = (rowObject) => CheckState.Unchecked;
            this.checkStatePutter = (rowObject, value) => value;
            this.rowFormatter = (item) => { };
            this.alwaysGroupByColumn = new OLVColumn();
            this.emptyListMsgFont = new Font("Tahoma", 14);
            this.groupWithItemCountFormat = "{0} [{1} items]";
            this.groupWithItemCountSingularFormat = "{0} [{1} item]";
            this.objects = new ArrayList();
            this.secondarySortColumn = new OLVColumn();
            this.LastSortColumn = new OLVColumn();
        ...
        /// <summary>
        /// Get or set whether the column selection menu stays open
        /// </summary>
        [Category("Behavior"),
        Description("Whether the column selection menu stays open"),
        DefaultValue(false)]
        ...
        private bool selectColumnsMenuStaysOpen = false;
        ...
        /// <summary>
        /// Freeze the listview so that it does not update until Unfreeze() is called
        /// </summary>
        public void Freeze()
        {
            freezeCount++;
        ...
        /// <summary>
        /// Unfreeze the listview, allowing it to update again
        /// </summary>
        ...
        public void EnableCustomSelectionColors()
        {
            ...
            foreach (OLVColumn column in this.AllColumns) {
                if (column.ColumnRendererDelegate == null)
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public OLVColumn? PrimarySortColumn
        {
            get { return this.primarySortColumn; }
            set { this.primarySortColumn = value; }
        }
        ...
        /// <summary>
        /// When the user clicks on a column header, which column will be used for secondary sorting?
        /// </summary>
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// When the user clicks on a column header, should the list sort by that column?
        /// </summary>
        [Category("Behavior"),
        Description("When the user clicks on a column header, should the list sort by that column?"),
        DefaultValue(true)]
        public bool SortOnHeaderClick
        {
            get { return sortOnHeaderClick; }
            set { sortOnHeaderClick = value; }
        }
        private bool sortOnHeaderClick = true;

        /// <summary>
        /// Should the list view show sort indicators in the column headers?
        /// </summary>
        [Category("Behavior"),
        ...
        private bool showSortIndicators = true;
        ...
        private bool showImagesOnSubItems = false;

        /// <summary>
        /// The style of view to be used for this list.
        /// </summary>
        /// <remarks>Only Detail and Tile views are supported currently.</remarks>
        [Category("Behavior"),
        Description("The style of view to be used for this list."),
        ...
        /// <summary>
        /// Copy the selected objects to the clipboard in text format.
        /// </summary>
        ...
        /// <summary>
        /// Set the collection of objects that this list will show
        /// </summary>
        ...
        /// </summary>
        public virtual void BuildList(bool shouldPreserveSelection)
        {
            // Implementation would go here
        }
        ...
        /// <summary>
        /// Gets the order in which the last sort was performed
        /// </summary>
        public SortOrder LastSortOrder { get; set; }
        
        /// <summary>
        /// Event handler for cell edit starting
        /// </summary>
        ...
        /// <summary>
        /// Event raised when cell editing is starting
        /// </summary>
        // public event CellEditEventHandler? CellEditStarting;
        
        /// <summary>
        /// Event raised when cell editing is finished
        /// </summary>
        ...
        /// </summary>
        // public event EventHandler SelectionChanged;  // Removed unused event
        ...
        public virtual void RefreshObjects(ICollection modelObjects)
        {
            // Implementation would go here
        }
        ...
        public class CellEditEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Create a CellEditEventArgs for the given column, control, item and subitem
            /// </summary>
            public CellEditEventArgs(OLVColumn? column, Control? control, OLVListItem? item, int subItemIndex)
            {
                this.column = column ?? throw new ArgumentNullException(nameof(column));
                this.control = control ?? throw new ArgumentNullException(nameof(control));
                this.listViewItem = item ?? throw new ArgumentNullException(nameof(item));
            ...
            /// <summary>
            /// Get or set the column of the cell that is going to be or has been edited.
            /// </summary>
            ...
            /// <summary>
            /// Get or set the control that is being used to edit the value of the cell.
            /// </summary>
            ...
            /// <summary>
            /// Get or set the listview item of the cell that is going to be or has been edited.
            /// </summary>
            ...
            /// <summary>
            /// Get or set the index of the row of the cell that is going to be or has been edited.
            /// </summary>
            public int RowIndex
            {
                get 
            ...
            /// <summary>
            /// Get or set the index of the column of the cell that is going to be or has been edited.
            /// </summary>
            ...
            /// <summary>
            /// Get or set the value that will be or has been assigned to the cell.
            /// </summary>
            public Object? Value
            {
                get { return value; }
            ...
            /// <summary>
            /// Get or set whether the cell edit event should be cancelled
            /// </summary>
            public bool Cancel
            {
                get { return cancel; }
            ...
            /// <summary>
            /// Get or set whether the value has been updated in the model object
            /// </summary>
            ...
            /// <summary>
            /// Get the row object associated with this event
            /// </summary>
        ...
        /// <summary>
        /// Handle column width changing events
        /// </summary>
        /// <param name="sender">The sender</param>
        /// <param name="e">Event arguments</param>
        ...
        /// <summary>
        /// Track whether we own the objects collection
        /// </summary>
        private bool isOwnerOfObjects = false;
        ...
        public OLVColumn? GetColumn(int index)
        {
            ...
            {
                return this.Columns[index] as OLVColumn;
            }
            return null;
        }
        ...
        /// </summary>
        /// <returns>ArrayList of checked objects</returns>
        ...
        public OLVListItem? GetItem(int index)
        {
            ...
            {
                return this.Items[index] as OLVListItem;
            }
            return null;
        }
        ...
        /// <param name="oldValue">Old check value</param>
        /// <param name="newValue">New check value</param>
        public void ChangeCheckItem(OLVListItem item, bool oldValue, bool newValue)
        {
            if (item != null && item.Checked != newValue)
            {
        ...
        /// <summary>
        /// Get filtered columns based on view
        /// </summary>
        /// <param name="view">The view type</param>
        /// <returns>List of filtered columns</returns>
        public List<OLVColumn> GetFilteredColumns(View view)
        {
            List<OLVColumn> filteredColumns = new List<OLVColumn>();
            foreach (OLVColumn column in this.AllColumns)
            {
                if (column.IsVisible)
                {
        ...
        /// <param name="column">The column at the point</param>
        /// <returns>The item at the given point</returns>
        public OLVListItem? GetItemAt(int x, int y, out OLVColumn? column)
        {
            column = null;
            Point pt = new Point(x, y);
            ListViewHitTestInfo hitTest = this.HitTest(pt);
            // ListViewHitTestInfo has Item and SubItem properties, but not Column
            // We need to determine the column from the subitem index
            if (hitTest.Item != null && hitTest.SubItem != null)
            {
                // Find the column index by matching the subitem
                for (int i = 0; i < hitTest.Item.SubItems.Count; i++)
                {
                    if (hitTest.Item.SubItems[i] == hitTest.SubItem)
                    {
                        // Get the column at this index
                        if (i < this.Columns.Count)
                        {
                            column = this.Columns[i] as OLVColumn;
                        }
                        break;
                    }
                }
            }
            return hitTest.Item as OLVListItem;
        }
        ...
        public void StartCellEdit(OLVListItem item, int subItemIndex)
        {
            if (item == null)
                return;
            ...
            // Implementation would go here
            // For now, we'll just call the EditSubItem method
            this.EditSubItem(item!, subItemIndex);
        }
        ...
        /// <summary>
        /// Setup the external image list
        /// </summary>
        public void SetupExternalImageList()
        {
            // Implementation would go here
        }
